...
<html lang="en">
  ...
  <body>
    <?php 
      $cardNumErr = $nameErr = $cvvErr = "";
      $isCardValid =  $isValidName = $isValidCvv = false;
      ...
      function validatecard($number)
      {
        ...
        $type= "amex";
          ...
          {
              $cardNumErr = "Your card number is invalid!";
              return false;
          } 
      }
      function validatename($name)
{
   global $nameErr;
    if (empty($name))
    {
        $nameErr = "Error!! Kindly enter the card name";
        return false;
    }
...
function validatecvv($cvv)
{
    ...
    {
       $cvvErr = "CVV ranges between 3 to 5";
       return false;
    }
    else
    {
      ...
      <main>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <?php if($isCardValid && $isValidName && $isValidCvv): ?>
  ...
  <div class="flex">
    ...
    <div class="ml-3">
      <p class="text-sm font-medium text-green-800">Payment Sucessful!</p>
    </div>
  </div>
</div>
<?php endif; ?>
              <div class="">
                ...
                <div class="mt-6 grid grid-cols-4 gap-y-6 gap-x-4">
                  <div class="col-span-4">
                    ...
                    <div class="mt-1">
                      ...
                      />
                      <p class="mt-2 text-sm text-red-600" ><?php echo $cardNumErr; ?></p>
                    </div>
                  </div>
                  ...
                  <div class="col-span-4">
                    ...
                    <div class="mt-1">
                      <input
                        ...
                        class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      />
                                            <p class="mt-2 text-sm text-red-600" ><?php echo $nameErr; ?></p>
                ...
                <p class="mt-2 text-sm text-red-600 text-right" ><?php echo $cvvErr; ?></p>
              </div>
